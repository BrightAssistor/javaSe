package java019_designmode.singleton;
/**
 * 单例模式
 * @author bristor
 *
 ...
 *
 */
class Singleton_lateLoad{
	private Singleton_lateLoad(){
		
	}
	
	private static class Singleton_lateLoad_inner{
		private static Singleton_lateLoad inner = new Singleton_lateLoad();
	}
	
	public static Singleton_lateLoad getInstance(){
		return Singleton_lateLoad_inner.inner;
